...
public class variant2_zadanie2 {
    public static void arr() throws InputMismatchException {
    ...
    public static void vivod(int[][] matrix) throws ArrayIndexOutOfBoundsException {
        Scanner sc = new Scanner(System.in);
